...
export const FALLBACK_CREDIT_RULES: CreditRule[] = [
  ...
  rule("WHOLESALE", ["stock", "goods for resale", "inventory", "pallet", "warehouse"], true, "Goods for resale / warehousing — direct input, gives credit.", 50),
  rule("HOSPITALITY", ["linen", "towel", "bedding", "laundry", "toiletries", "cleaning product", "detergent"], true, "Guest-room consumables — deductible.", 50),
  rule("HOSPITALITY", ["prawn", "prawns", "shrimp", "fish", "meat", "vegetable", "flour", "oil", "ingredient"], true, "Kitchen input for the hotel restaurant — used in the taxable activity, gives credit.", 51),
  rule("HOSPITALITY", ["kitchen equipment", "oven", "fridge", "utensil", "cookware"], true, "Kitchen equipment used in operations — deductible.", 52),
  rule("CONSTRUCTION", ["cement", "timber", "brick", "steel", "plumbing", "electrical", "insulation", "tile", "paint", "scaffolding", "ppe", "safety", "tool", "plant hire", "machinery"], true, "Building materials/tools/plant used directly in construction works — deductible.", 50),
  rule("PROFESSIONAL", ["software", "subscription", "stationery", "office supplies", "printer", "laptop", "computer", "license"], true, "Office/IT costs used in the professional service activity — deductible.", 50),
  rule("TRANSPORT", ["diesel", "fuel", "tyre", "tire", "vehicle part", "maintenance", "spare part", "freight", "haulage", "pallet"], true, "Commercial vehicle/logistics running costs — deductible. Does not affect the general block on passenger-car petrol.", 50),
  rule("AGRICULTURE", ["feed", "fertilizer", "seed", "seeds", "livestock", "veterinary", "vet", "tractor", "fencing"], true, "Farm inputs used in the agricultural activity — deductible. Assumes normal VAT registration (not the Flat-Rate Farmers Scheme).", 50),
  rule("MANUFACTURING", ["raw material", "component", "parts", "machinery", "factory equipment", "packaging", "maintenance"], true, "Raw materials/production equipment used directly in manufacturing — deductible.", 50),
  rule("HEALTHCARE", ["medical supplies", "ppe", "pharmaceutical", "clinical equipment"], false, "Healthcare services are typically VAT-exempt in Ireland, which restricts input VAT recovery — review with the client's tax advisor before taking credit (apportionment may apply).", 50),
];
